...
module.exports = {
    registerUser: function(username, callback) {
        ...
        return fabric_client.createUser(
            ...
            var msg = 'user was successfully registered and enrolled and is ready to intreact with the fabric network'
            console.log(msg);
            callback(true, msg);
        }).catch((err) => {
            console.error('Failed to register: ' + err);
            if(err.toString().indexOf('Authorization') > -1) {
                var errmsg = 'Authorization failures may be caused by having admin credentials from a previous CA instance.\n' +
